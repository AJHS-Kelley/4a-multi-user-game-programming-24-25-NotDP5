...
// // Sorting an array
// int[] intArr = {-25, 50, 68, 523, -1205, 675483, -1, 55, 0, 124};
// string[] zooAnimals = {"Rhinos", "Zebra", "Elephants", "Moose", "Iguana"};
Array.Sort(intArr);
Array.Sore(zooAnimals);
...
//Finding the Min, Max, and Sum, fro numerical arrays
Console.WriteLine("The minimum value for intArr is: " + intArr.Min());
Console.WriteLine("The minimum value for intArr is: " + intArr.Max());
Console.WriteLine("The minimum value for intArr is: " + intArr.Sum());
